...
async def create_private_poll(message: types.Message):
    ...
    user_meme_message = await bot.send_photo(bot_config["moderate_channel_id"], message.photo[1].file_id,
    ...
    message_with_poll = await bot.send_poll(bot_config["moderate_channel_id"],
                                            question, UsersMemePoll.OPTIONS,
                                            UsersMemePoll.DISABLE_NOTIFICATION,
                                            user_meme_message.message_id)
